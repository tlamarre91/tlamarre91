...
-- vim.o.foldopen.remove("block") -- TODO
...
local function telescope_config_files()
  local path = vim.api.nvim_list_runtime_paths()[1]
...
vim.keymap.set('n', '<leader>sc', telescope_config_files, { desc = '[S]earch [c]onfig files' })
